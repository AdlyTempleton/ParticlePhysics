...
public class GrinderTileEntity extends TileEntityElectricityRunnable implements IPacketReceiver, IElectricityStorage, IInventory{
    ...
    public void producePower(){
		...
		if (!this.isDisabled())
		{
			...
			if (this.connectedElectricUnit != null)
			{
					...
					this.connectedElectricUnit.getNetwork().startProducing(this, (10000 / this.getVoltage()) / 20, this.getVoltage());
