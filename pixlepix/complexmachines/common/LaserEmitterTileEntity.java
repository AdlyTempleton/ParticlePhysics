...
public class LaserEmitterTileEntity extends TileEntityElectricityRunnable implements IPacketReceiver, IElectricityStorage{
    ...
    {   
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (inputNetwork != null)
            {
                ...
                ticks++;
                if(getJoules()>10000){
                	System.out.println("Energy to fire");
                	if(ticks%40==0){
                		...
                		for(int i=1;i<25;i++){
                			if(worldObj.getBlockId(xCoord+laserDirection.offsetX*i, yCoord, zCoord+laserDirection.offsetZ*i)==0){
                				worldObj.setBlock(xCoord+laserDirection.offsetX*i, yCoord, zCoord+laserDirection.offsetZ*i, ComplexMachines.blockStartingID+10);
